...
public class Node {
	...
	public List<Node> findLeaf(Node node) {
	...
	public static Comparator<Node> LabelComparatorReverse = Comparator.comparing(Node::getLabel).reversed();
}